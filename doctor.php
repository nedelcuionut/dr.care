      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Qualified <?php echo $vector[2] ?></h1>
		...
		<section class="ftco-section">
			<div class="container">
				<div class="row">
                          ...
                          <?php          
                         $selectDoctor = "SELECT * FROM `doctor` ORDER BY id DESC LIMIT 4";           
                         $resultSelectDoctor  = $conn->query($selectDoctor);  
                             if ($resultSelectDoctor->num_rows > 0) {
            while($row = $resultSelectDoctor->fetch_assoc()) {
            
            echo '					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/'.$row['img'].');"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>'.$row['name'].';
            </h3>
								<span class="position mb-2">'.$row['specializare'].'</span>
								<div class="faded">
									<p>'.$row['descriere'].'</p>
